...
const ProductInventoryMovement: React.FC = () => {
    ...
    const fetchProductInventoryMovements = async (
        pageNumber = page,
        size = pageSize
    ) => {
        try {
            ...
            const res = await axiosInstance.get(
                `${Api.ProductInventoryMovements}?${params.toString()}`
            );
    ...
    useEffect(() => {
        fetchProductInventoryMovements(page, pageSize);
    ...
    const handlePageChange = (newPage: number) => {
        setPage(newPage);
        fetchProductInventoryMovements(newPage, pageSize);
    };

    const handlePageSizeChange = (size: number) => {
        setPageSize(size);
        setPage(1);
        fetchProductInventoryMovements(1, size);
    };
                ...
                <div className="flex items-end">
                    <button
                        onClick={() => {
                            ...
                            fetchProductInventoryMovements(1, pageSize);
                        }}
