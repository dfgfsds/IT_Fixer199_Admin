...
const CreateAgentModal = ({ show, onClose, onSuccess }: any) => {
    ...
    const handleSubmit = async () => {
        ...
        if (!form.profile_image) return toast.error("Profile Image required");
        if (!form.aadhar_doc) return toast.error("Aadhar required");
        if (!form.pan_card) return toast.error("PAN required");
        if (!form.license_doc) return toast.error("License required");
        if (!form.video_kyc) return toast.error("Video KYC required");
        if (!form.rc_doc) return toast.error("RC Document required");
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <input placeholder="Mobile *" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, mobile_number: e.target.value })} />
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <input type="time" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, start_time: e.target.value })} />
                                <input type="time" className={inputClass}
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <input placeholder="Vehicle Type" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, vehicle_type: e.target.value })} />
                                <input placeholder="Vehicle Number" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, vehicle_number: e.target.value })} />
                                <input placeholder="RC Number" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, rc_number: e.target.value })} />
                                <input placeholder="License Number" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, license_number: e.target.value })} />
                            </div>
                        </div>
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <input placeholder="Bank Name" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, bank_name: e.target.value })} />
                                <input placeholder="Account Number" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, account_number: e.target.value })} />
                                <input placeholder="IFSC" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, ifsc_code: e.target.value })} />
                                <input placeholder="UPI ID" className={inputClass}
                                    required onChange={(e) => setForm({ ...form, upi_id: e.target.value })} />
                            </div>
                        </div>
